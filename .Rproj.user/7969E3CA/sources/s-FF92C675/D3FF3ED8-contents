...
#' @param pcol color of the line of the polygon
#' @param pfcol color to fill the area of the polygon, default is NULL.
...
#' origami_plot(df=df_list[[1]], pcol = rgb(0.2,0.5,0.5,1),pfcol = rgb(0.2,0.5,0.5,0.1),axistype=1, pty = 32)
#'
#' @export

origami_plot<- function(df, pcol, pfcol=NULL, axistype=0, seg=4, pty=16, plty=1:6, plwd=1,
